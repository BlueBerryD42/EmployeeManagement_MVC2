    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (id != null && name != null && note != null) {
                ...
                kq = d.updateSkill(Integer.parseInt(id.trim()), name, note);
                if (kq == 1) {
                    request.getRequestDispatcher("getSkillServlet").forward(request, response);
                    return;
                } else {
                    error = true;
                }
            ...
            if (error == true) {
                ...
                request.getRequestDispatcher("UpdateSkillPage.jsp").forward(request, response);
            }
